...
- **Mise à jour automatique des dates de vacances via API (https://calendrier-api.atome-dev.fr/api/vacances)**
...
├── config/
│   └── vacances.json.sample   # Exemple de données reçues de l'API
...
---
Projet API pour la mise à jour des données : https://github.com/atome-dev/calendrier-api